...
var rowKeys = ['flb-start', 'flb-center', 'flb-end', 'flb-top', 'flb-middle', 'flb-bottom', 'flb-around', 'flb-between'];
...
function getRowClassNames(props) {
  var modificators = [props.className, (0, _classNames2.default)('flb-row')];
  ...
  if (props.reverse) {
    modificators.push((0, _classNames2.default)('flb-reverse'));
  }
